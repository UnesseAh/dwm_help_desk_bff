import {connectedUser, resetPasswordUser, statsUsersByRoleUser, toggleActivationUser, updateUser, userListGet, userLogin, userRegister}  from "../controllers/userController";
...
router.patch("/resetPassword", authorize(["ADMIN"]), resetPasswordUser);
